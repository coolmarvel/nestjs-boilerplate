...
import { SettingGetDoc, SettingListDoc } from 'src/common/setting/docs/setting.doc';
...
export class SettingPublicController {
  ...
  async list(
    ...
    const settings: SettingEntity[] = await this.settingService.findAll(find, { paging: { limit: _limit, offset: _offset }, order: _order });

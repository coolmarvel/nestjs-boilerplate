...
export function ApiKeyUserUpdateGuard(): MethodDecorator {
  return applyDecorators(UseGuards(ApiKeyPayloadPutToRequestGuard, ApiKeyNotFoundGuard, ApiKeyActiveGuard, ApiKeyExpiredGuard), SetMetadata(API_KEY_ACTIVE_META_KEY, [true]));
}

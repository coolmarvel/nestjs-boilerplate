...
import { ApiKeyActiveDoc, ApiKeyCreateDoc, ApiKeyGetDoc, ApiKeyInactiveDoc, ApiKeyListDoc, ApiKeyResetDoc, ApiKeyUpdateDoc } from 'src/common/api-key/docs/api-key.admin.doc';
...
export class ApiKeyAdminController {
  ...
  async list(
    ...
    const apiKeys: ApiKeyEntity[] = await this.apiKeyService.findAll(find, { paging: { limit: _limit, offset: _offset }, order: _order });
  ...
  async create(@Body() { user, ...body }: ApiKeyCreateDto): Promise<IResponse> {
    ...
    try {
      const created: IApiKeyCreated = await this.apiKeyService.create({ ...body, user });

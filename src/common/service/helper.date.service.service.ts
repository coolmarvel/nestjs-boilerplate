...
import { IHelperDateService } from '../helper/interface/helper.date-service.interface';
import {
...
} from '../helper/interface/helper.interface';
import { ENUM_HELPER_DATE_DIFF, ENUM_HELPER_DATE_FORMAT } from '../helper/constant/helper.enum.constant';
...
export class HelperDateService implements IHelperDateService {
  ...
  extractDate(date: string | Date | number): IHelperDateExtractDate {
    ...
    const day: string = this.format(newDate, { format: ENUM_HELPER_DATE_FORMAT.ONLY_DATE });
    const month: string = this.format(newDate, { format: ENUM_HELPER_DATE_FORMAT.ONLY_MONTH });
    const year: string = this.format(newDate, { format: ENUM_HELPER_DATE_FORMAT.ONLY_YEAR });

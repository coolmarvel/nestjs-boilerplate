...
export abstract class DatabaseBaseRepositoryAbstract<Entity> {
  ...
  abstract findOneAndLock<T = Entity>(find: Record<string, any>, options?: IDatabaseFindOneOptions<any>): Promise<T>;

  abstract findOneByIdAndLock<T = Entity>(_id: string, options?: IDatabaseFindOneOptions<any>): Promise<T>;

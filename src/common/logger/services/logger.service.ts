...
export class LoggerService implements ILoggerService {
  ...
  async info({ action, description, apiKey, user, method, requestId, role, type, params, bodies, path, statusCode, tags }: LoggerCreateDto): Promise<LoggerDoc> {
  ...
  async debug({ action, description, apiKey, user, method, requestId, role, type, params, bodies, path, statusCode, tags }: LoggerCreateDto): Promise<LoggerDoc> {
    const create: LoggerEntity = new LoggerEntity();
  ...
  async warn({ action, description, apiKey, user, method, requestId, role, type, params, bodies, path, statusCode, tags }: LoggerCreateDto): Promise<LoggerDoc> {
    const create: LoggerEntity = new LoggerEntity();
  ...
  async fatal({ action, description, apiKey, user, method, requestId, role, type, params, bodies, path, statusCode, tags }: LoggerCreateDto): Promise<LoggerDoc> {
    const create: LoggerEntity = new LoggerEntity();
  ...
  async raw({ level, action, description, apiKey, user, method, requestId, role, type, params, bodies, path, statusCode, tags }: LoggerCreateRawDto): Promise<LoggerDoc> {
    const create: LoggerEntity = new LoggerEntity();
    create.level = level;
    create.user = user;
    create.apiKey = apiKey;

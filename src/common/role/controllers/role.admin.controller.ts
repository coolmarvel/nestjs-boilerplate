import { Body, ConflictException, Controller, Delete, Get, InternalServerErrorException, Patch, Post, Put } from '@nestjs/common';
...
import { RoleAdminDeleteGuard, RoleAdminGetGuard, RoleAdminUpdateActiveGuard, RoleAdminUpdateGuard, RoleAdminUpdateInactiveGuard } from 'src/common/role/decorators/role.admin.decorator';
import { GetRole } from 'src/common/role/decorators/role.decorator';
import { RoleActiveDoc, RoleCreateDoc, RoleDeleteDoc, RoleGetDoc, RoleInactiveDoc, RoleListDoc, RoleUpdateDoc } from 'src/common/role/docs/role.admin.doc';
...
import { RoleDoc, RoleEntity } from 'src/common/role/repository/entities/role.entity';
...
export class RoleAdminController {
  ...
  async list(
    ...
    const roles: RoleEntity[] = await this.roleService.findAll(find, { paging: { limit: _limit, offset: _offset }, order: _order });
  ...
  @PolicyAbilityProtected({ subject: ENUM_POLICY_SUBJECT.ROLE, action: [ENUM_POLICY_ACTION.READ, ENUM_POLICY_ACTION.CREATE] })
  @AuthJwtAdminAccessProtected()
  @Post('/create')
  ...
  @PolicyAbilityProtected({ subject: ENUM_POLICY_SUBJECT.ROLE, action: [ENUM_POLICY_ACTION.READ, ENUM_POLICY_ACTION.UPDATE] })
  @AuthJwtAdminAccessProtected()
  @RequestParamGuard(RoleRequestDto)
  @Put('/update/:role')
  ...
  @PolicyAbilityProtected({ subject: ENUM_POLICY_SUBJECT.ROLE, action: [ENUM_POLICY_ACTION.READ, ENUM_POLICY_ACTION.DELETE] })
  @AuthJwtAdminAccessProtected()
  @RequestParamGuard(RoleRequestDto)
  @Delete('/delete/:role')

...
export default registerAs(
  ...
  (): Record<string, any> => ({
    ...
    refreshToken: {
      ...
      notBeforeExpirationTime: seconds(process.env.AUTH_JWT_REFRESH_TOKEN_NOT_BEFORE_EXPIRATION ?? '1h'), // 1 hours
    ...
    subject: process.env.AUTH_JWT_SUBJECT ?? 'coolmarvel_development',

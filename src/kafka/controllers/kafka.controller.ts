...
import { MessageCommitOffsetInFirstRunning, MessageTopic, MessageValue } from 'src/kafka/decorators/kafka.decorator';
...
export class KafkaController {
  ...
  async helloKafka(@MessageValue() value: Record<string, any>): Promise<IKafkaResponse> {
    return value;
  }

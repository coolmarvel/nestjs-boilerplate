...
import { DiskHealthIndicator, HealthCheck, HealthCheckService, MemoryHealthIndicator, MicroserviceHealthIndicator, MongooseHealthIndicator } from '@nestjs/terminus';
    ...
    const data = await this.health.check([
      () =>
        this.microserviceIndicator.pingCheck('kafka', {
          ...
          timeout: 10000,
          options: {
            client: { brokers: this.configService.get<string[]>('kafka.brokers') },
          },
        }),
    ]);
